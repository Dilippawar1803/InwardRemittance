...
public class InwardRemittanceTest extends BaseTest{
	...
	public void initializeEnvironment() {
		...
		objCommonFlow.setResourceName("Test Automation User");
...
//	}
	...
	public void TCID_FCC_CG_IRM_001_MessageToBank_MenuOptions_Verification() {
		this.loadTestData("TCID_FCC_CG_IRM_001_MessageToBank_MenuOptions_Verification");
	...
	public void TCID_FCC_CG_IRM_0008_VerifySearchCriteriaTransactions() {
		this.loadTestData("TCID_FCC_CG_IRM_0008_VerifySearchCriteriaTransactions");
		if (!this.getObjUtilities().dpString("runmode").equals("Y")) {
			throw new SkipException("Run Mode 'No'");
		}
//		objCommonFlow.openAUT_URL();
...
//		objCommonFlow.clickOnTradeLink();
	...
	public void TCID_FCC_CG_IRM_0010_VerifyMenuOptionsAvailable() {
		this.loadTestData("TCID_FCC_CG_IRM_0010_VerifyMenuOptionsAvailable");
		if (!this.getObjUtilities().dpString("runmode").equals("Y")) {
			throw new SkipException("Run Mode 'No'");
		}
//		objCommonFlow.openAUT_URL();
...
//		objCommonFlow.clickOnTradeLink();
	...
	public void TCID_FCC_CG_IRM_0011_VerifyTransactionsReceivedFromNostroUtility() {
		this.loadTestData("TCID_FCC_CG_IRM_0011_VerifyTransactionsReceivedFromNostroUtility");
		if (!this.getObjUtilities().dpString("runmode").equals("Y")) {
			throw new SkipException("Run Mode 'No'");
		}
//		objCommonFlow.openAUT_URL();
...
//		objCommonFlow.clickOnTradeLink();
	...
	public void TCID_FCC_CG_IRM_0025_verifyAuditDetailsForInwardRemittanceTransaction() {
		this.loadTestData("TCID_FCC_CG_IRM_0025_verifyAuditDetailsForInwardRemittanceTransaction");
		if (!this.getObjUtilities().dpString("runmode").equals("Y")) {
			throw new SkipException("Run Mode 'No'");
		}
//		objCommonFlow.openAUT_URL();
...
//		objCommonFlow.clickOnTradeLink();
	...
	public void TCID_FCC_CG_IRM_0026_verifyAuditDetailsForRemittanceCreditTransaction() {
		this.loadTestData("TCID_FCC_CG_IRM_0026_verifyAuditDetailsForRemittanceCreditTransaction");
		if (!this.getObjUtilities().dpString("runmode").equals("Y")) {
			throw new SkipException("Run Mode 'No'");
		}
//		objCommonFlow.openAUT_URL();
...
//		objCommonFlow.clickOnTradeLink();
	...
	public void TCID_FCC_CG_IRM_0034_verifyTransactionCopyValidation() {
		this.loadTestData("TCID_FCC_CG_IRM_0034_verifyTransactionCopyValidation");
		if (!this.getObjUtilities().dpString("runmode").equals("Y")) {
			throw new SkipException("Run Mode 'No'");
		}
//		objCommonFlow.openAUT_URL();
...
//		objCommonFlow.clickOnTradeLink();
	...
	public void TCID_FCC_CG_IRM_031_verifyPullBackMenuOptionsInFTI() {
		this.loadTestData("TCID_FCC_CG_IRM_031_verifyPullBackMenuOptionsInFTI");
		if (!this.getObjUtilities().dpString("runmode").equals("Y")) {
			throw new SkipException("Run Mode 'No'");
		}
	...
	public void TCID_FCC_CG_IRM_032_verifyPullBackEnquirySubmenuInFTI() {
		this.loadTestData("TCID_FCC_CG_IRM_032_verifyPullBackEnquirySubmenuInFTI");
		if (!this.getObjUtilities().dpString("runmode").equals("Y")) {
			throw new SkipException("Run Mode 'No'");
		}
		objFTI.clickNostroUtility();
	...
	public void TCID_FCC_CG_IRM_033_verifyFunctionalityOfPullBackFCCSubmenu() {
		this.loadTestData("TCID_FCC_CG_IRM_033_verifyFunctionalityOfPullBackFCCSubmenu");
		if (!this.getObjUtilities().dpString("runmode").equals("Y")) {
			throw new SkipException("Run Mode 'No'");
		}
		objFTI.clickNostroUtility();
